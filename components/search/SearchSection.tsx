        ...
        <div ref={resultsRef} className="scroll-mt-4">
          ...
          {search.status === 'found' && (
            <div className="space-y-3">
              ...
              <div
                ref={summaryRef}
                className="rounded-2xl border border-white/[0.06] bg-owa-card p-5 shadow-xl shadow-black/25 scroll-mt-3"
              >
                <div>
                  <h2 className="text-base font-black leading-tight">
                    <span className="text-owa-gold">{search.route.origin_label}</span>
                    <span className="mx-2 inline-flex items-center text-owa-mist/40">
                      <ArrowRight size={16} />
                    </span>
                    <span className="text-owa-white">{search.route.destination_label}</span>
                  </h2>
